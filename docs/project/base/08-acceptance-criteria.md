...
4. **Cobertura da superfície alterada**: Toda superfície tocada pela feature tem teste automatizado na camada certa — lógica/API em Jest de integração; **UI com lógica em teste de render/interação (RTL + `jsdom`)**. Um crash de render não pode passar em "verde". Ver a Política de Testes em `docs/project/base/07` §4.1.
